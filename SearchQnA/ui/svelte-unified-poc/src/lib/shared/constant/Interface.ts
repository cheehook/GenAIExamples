...
export interface Component {
	component_id: number; // The unique identifier for each component
	type: string; // The type of the component (e.g., 'ChatInput')
	props: {
	  label: string; // Label property in the props object
	};
  }
